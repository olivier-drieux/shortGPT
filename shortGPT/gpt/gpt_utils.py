...
def gpt3Turbo_completion(chat_prompt="", system="You are an AI that can give the answer to anything", temp=0.7, model="gpt-4", max_tokens=1000, remove_nl=True, conversation=None):
